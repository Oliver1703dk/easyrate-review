...
export const DASHBOARD_TEXT = {
  ...
  test: {
    ...
    // Send test section
    sendTestTitle: 'Send Test Besked',
    sendTestDescription: 'Send en test SMS eller email til dig selv for at teste flowet.',
    phoneLabel: 'Telefonnummer',
    phonePlaceholder: '+45 12345678',
    emailLabel: 'Email',
    emailPlaceholder: 'din@email.dk',
    customerNameLabel: 'Kundenavn (valgfrit)',
    customerNamePlaceholder: 'Anders',
    sendButton: 'Send Test Besked',
    sending: 'Sender...',
    // Status display
    statusTitle: 'Status',
    ...
    smsTo: 'SMS til',
    emailTo: 'Email til',
    openTestLink: 'Åbn Test Link',
    sendAnother: 'Send ny test',
    validationError: 'Indtast mindst et telefonnummer eller en email',
  },
  flow: {
  ...
  integrations: {
    ...
    dully: {
      ...
      webhookSecretDescription: 'Webhook secret fra Dully til signaturverifikation',
      connectionStatus: 'Forbindelsesstatus',
      lastWebhook: 'Sidste webhook',
      webhookCount: 'Webhooks modtaget',
      neverReceived: 'Ingen modtaget endnu',
      setupInstructions: [
        'Log ind på din Dully admin',
        'Gå til Indstillinger > API & Webhooks',
        'Kopier webhook URL og indsæt den i Dully',
        'Kopier webhook secret og indsæt den herunder',
        'Gem indstillingerne i begge systemer',
      ],
      benefits: [
